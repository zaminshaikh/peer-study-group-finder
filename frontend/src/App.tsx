      ...
      <nav className="fixed top-0 w-full bg-gray-950/80 backdrop-blur-sm shadow-sm z-50 border-b border-yellow-800">
        <div className="relative flex items-center h-24">
          ...
          <div className="absolute right-6 flex space-x-2">
            <button className="px-4 py-2 text-gray-200 rounded-lg hover:text-yellow-600 transition-colors">
              Login
            </button>
            <button className="px-4 py-2 bg-gradient-to-r from-yellow-600 to-yellow-900 text-gray-200 rounded-lg hover:opacity-90 transition-opacity">
              Sign Up
            </button>
          </div>
        </div>
