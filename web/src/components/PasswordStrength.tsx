...
import { Check, X } from "lucide-react"; // Ensure to import the icons
...
const PasswordStrengthMeter: React.FC<PasswordStrengthMeterProps> = ({
  ...
  const getColor = (strength: number) => {
    ...
    if (strength === 2) return "bg-yellow-400"; // Change this to avoid duplication
  ...
  return (
    <div className="mt-2">
      ...
      {/* Correctly rendering the component */}
    </div>
  );
};
